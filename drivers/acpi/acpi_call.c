...
/*
 * acpi_call.c - Support calls to ACPI methods through /proc/acpi/call
 *
 * Copyright (c) 2010        Michal Kottman
 * Copyright (c) 2017, 2020  NixOS Community
 */
...
MODULE_AUTHOR("Michal Kottman");
MODULE_DESCRIPTION("Arbitrary ACPI call support");
MODULE_LICENSE("GPL");
